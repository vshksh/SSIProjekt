	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="div-form">
				<h3>Rejestracja</h3>
				<form method="POST" modelAttribute="formularzRejestracji"
					class="form-horizontal" role="form">
					<div class="form-group">

						<label for="login" class="col-sm-2 control-label"> Twój
							login </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<button type="submit" class="btn btn-default">Rejestruj
							</button>
						</div>
					</div>
				</form>
